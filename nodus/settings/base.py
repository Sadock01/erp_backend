...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-(a%bd3od2=oub^_$1uc@=i_2n5lyg=!4%#q+-@zk*j+z_o+qto')
...
WSGI_APPLICATION = 'nodus.wsgi.application'
...
# Django REST Framework (API JSON uniquement en sortie ; auth par jeton)
REST_FRAMEWORK = {
